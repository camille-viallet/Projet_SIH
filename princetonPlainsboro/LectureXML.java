                ...
                switch (event) {
                    ...
                    case XMLStreamConstants.END_ELEMENT:
                        if (parser.getLocalName().equals("acte")) {
                            actes.add(new Acte(codeCourant, coefCourant, nomActe, med, dateActe, typeCourant, comm));
                        }
                        ...
                        if (parser.getLocalName().equals("coef")) {
                            ...
                            // !! il faut ajouter le nomActe, le nom du médicin med, la dateActe, le typeCourant et le comm
                        }
                        if (parser.getLocalName().equals("date")) {
                            ...
                            int heure = Integer.parseInt(donneesCourantes.substring(0, donneesCourantes.indexOf('h')));
                            int minute = Integer.parseInt(donneesCourantes.substring(0, donneesCourantes.indexOf('.')));
